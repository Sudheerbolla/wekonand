 ...
 */
public class ForgotPasswordVerifyOTPFragment extends BaseFragment implements View.OnClickListener, IParser<WSResponse> {
    public static final String TAG = ForgotPasswordVerifyOTPFragment.class.getSimpleName();
     ...
     */
    public static ForgotPasswordVerifyOTPFragment newInstance(String otp) {
        ForgotPasswordVerifyOTPFragment fragment = new ForgotPasswordVerifyOTPFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            if (rootView == null) {
                rootView = inflater.inflate(R.layout.fragment_forgot_password_verify_otp, null);
    ...
    @Override
    @OnClick({R.id.tv_resend_otp, R.id.tv_verify})
    ...
    private void requestResendOTP() {
        ...
        params.put(WSUtils.KEY_OTP_TYPE, "2");//otp_type [0 - register/ 1- profile / 2 - MobileResetPwd]
                ...
                PopupUtil.showAlertMessage(activity, getString(R.string.verification_is_successful), response.getSettings().getMessage(),
                        getString(R.string.ok), new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                activity.replaceFragment(ResetPasswordFragment.newInstance(otp, response.getData().get(0).getUserId()), false, true, false, true);
                            }
                        });
            } else {
                CommonUtil.showSnackbar(getView(), response.getSettings().getMessage() + "");
