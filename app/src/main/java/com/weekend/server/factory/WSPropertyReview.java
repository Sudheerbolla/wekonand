 ...
 */
public class WSPropertyReview extends WSUtils {
    public WSPropertyReview() {
        super();
    }

    @Override
    public void enqueueWebService(Map<String, String> params, Map<String, RequestBody> fileUploadParams, Callback callback) {
        Call<PropertyReviewListModel> subCategoryCall = webServices.requestPropertyReviewList(params);
