 ...
 */
public class WSCustomerRegister extends WSUtils {
    public WSCustomerRegister() {
        super();
    }

    @Override
    public void enqueueWebService(Map<String, String> params, Map<String, RequestBody> fileUploadParams, Callback callback) {
        Call<CustomerRegisterModel> subCategoryCall = webServices.requestCustomerRegister(params);
