 ...
 */
public class SearchFragmentBc extends BaseFragment implements View.OnClickListener, CompoundButton.OnCheckedChangeListener, IParser<WSResponse>, ISingleSelectionClick, IMultipleSelectionClick {
    public static final String TAG = SearchFragmentBc.class.getSimpleName();
     ...
     */
    public static SearchFragmentBc newInstance() {
        SearchFragmentBc fragment = new SearchFragmentBc();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            if (rootView == null) {
                rootView = inflater.inflate(R.layout.fragment_search_bc, null);
            }
    ...
    private void onSoccerEvent() {
        ...
        llLeasing.setVisibility(View.GONE);
        tvSizeTitle.setText(R.string.size_number_of_players);
