...
import com.weekend.utils.GetFilepathFromUriTask;
...
public class ImagePickHelperFragment extends Fragment {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (isResultFromImagePick(requestCode, resultCode, data)) {
            if (requestCode == ImageUtil.CAMERA_REQUEST_CODE && (data == null || data.getData() == null)) {
                ...
                data = new Intent();
                data.setData(Uri.fromFile(ImageUtil.getLastUsedCameraFile()));
            }
    ...
    private boolean isResultFromImagePick(int requestCode, int resultCode, Intent data) {
        return resultCode == Activity.RESULT_OK
                && ((requestCode == ImageUtil.CAMERA_REQUEST_CODE)
                || (requestCode == ImageUtil.GALLERY_REQUEST_CODE && data != null));
    }
}