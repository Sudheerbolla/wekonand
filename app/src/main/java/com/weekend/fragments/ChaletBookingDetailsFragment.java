 ...
 */
public class ChaletBookingDetailsFragment extends BaseFragment implements View.OnClickListener, ICancelBookingClick, IParser<WSResponse> {
    public static final String TAG = ChaletBookingDetailsFragment.class.getSimpleName();
     ...
     */
    public static ChaletBookingDetailsFragment newInstance(MyBookingsModel.Datum booking_item) {
        ChaletBookingDetailsFragment fragment = new ChaletBookingDetailsFragment();
    ...
    public static ChaletBookingDetailsFragment newInstance(PushNotificationModel notificationBundle) {
        ChaletBookingDetailsFragment fragment = new ChaletBookingDetailsFragment();
        Bundle bundle = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            if (rootView == null) {
                rootView = inflater.inflate(R.layout.fragment_chalet_booking_details, null);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_navbar_share:
                ...
                //String shareText = getString(R.string.chalet_name)+": " + (myBookingItem.getPropertyTitle() + "").trim();
    ...
    private void setBookingDetailData() {
        ...
        if (bookingDetails != null) {
            ...
            tvChaletName.setText(bookingDetails.getChaletName());
            ...
            tvCheckinTime.setText(" " + bookingDetails.getCheckInTime());
            tvCheckoutTime.setText(" " + bookingDetails.getCheckOutTime());
