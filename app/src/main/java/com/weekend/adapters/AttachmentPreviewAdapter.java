...
public class AttachmentPreviewAdapter extends BaseListAdapter<File> {
    ...
    public void add(final File item) {
        ...
        ChatServiceUtil.getInstance().loadFileAsAttachment(item, new QBEntityCallback<QBAttachment>() {
            @Override
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(WeekendApplication.getInstance())
                .load(attachmentFile)
                .override(ResourceUtils.getDimen(R.dimen.space_80),
                        ResourceUtils.getDimen(R.dimen.space_80))
