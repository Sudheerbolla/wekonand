 ...
 */
public class WSNeighbourhoodList extends WSUtils {
    public WSNeighbourhoodList() {
        super();
    }

    @Override
    public void enqueueWebService(Map<String, String> params, Map<String, RequestBody> fileUploadParams, Callback callback) {
        Call<NeighbourhoodModel> subCategoryCall = webServices.requestNeighbourhoodList(params);
