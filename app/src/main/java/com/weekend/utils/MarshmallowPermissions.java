...
public class MarshmallowPermissions {
    ...
    private static final String TAG = MarshmallowPermissions.class.getSimpleName();

    public static final int RUNTIME_LOCATION_PERMISSION = 9991;
    public static final int RUNTIME_CAMERA_PERMISSION = 9992;
