 ...
 */
public class WSAbuseReasonList extends WSUtils {
    public WSAbuseReasonList() {
        super();
    }

    @Override
    public void enqueueWebService(Map<String, String> params, Map<String, RequestBody> fileUploadParams, Callback callback) {
        Call<AbuseReasonListModel> subCategoryCall = webServices.requestAbuseReasonList(params);
